...
function RecordScreen() {
  ...
  return (
    <main className="flex justify-end ">
      <section className="w-[300px] px-6 pt-6 pb-8 space-y-4 rounded-3xl shadow-2xl bg-[#fff]">
        ...
        <button
          type="submit"
          className="p-4 w-full text-[#fff] rounded-xl bg-primary-500 font-workSans bg-background"
        >
          <Link to="/permission" className="mt-10">
            Start Recording
          </Link>
        </button>
      </section>
